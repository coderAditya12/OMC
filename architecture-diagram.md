# OpenSource Compass - Architecture Diagram

## For Eraser.io
Copy the code below and paste it into https://app.eraser.io/
...
### ✅ Smart Caching Layer
- **Redis** for user profiles (15min TTL) and hot issues (30min TTL)
- Reduces database load by ~60%
- Fallback to PostgreSQL on cache miss

### 🤖 LangGraph Agentic AI
- **State machine** with tool calling
- **Intent classification** to prevent hallucinations
- **3 GitHub tools** for repository exploration
- **Session caching** for performance

### 📚 RAG Pipeline
- **Cohere embeddings** (384 dimensions, free tier)
- **Pinecone vector DB** for README chunks
- **Overlap chunking** for context preservation
- **Similarity search** for relevant context

### ⚡ Background Processing
- **GitHub Actions** cron jobs for data sync
- **Issue syncer** with difficulty detection
- **README indexer** with batch processing
- **Rate limiting** to respect API limits

### 🎯 Recommendation Engine
- **Profile creation** from user's GitHub repos
- **Language extraction** and filtering
- **Issue matching** with scoring algorithm
...
3. **Copy** any of the diagram codes above
4. **Paste** into Eraser.io
5. **Export** as high-res PNG or SVG
6. **Share** on LinkedIn!

### 💡 Recommended Approach:
- **Diagram 1** (Complete System Architecture): Best for showing the full tech stack
- **Diagram 2** (Request Flow): Perfect for explaining how the system works
- **Diagram 3** (Database Schema): Great for technical discussions

You can also create a **carousel post** on LinkedIn with all three diagrams! 🎨
