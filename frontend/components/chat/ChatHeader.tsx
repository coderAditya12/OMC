                        ...
                        <div className="flex items-start justify-between gap-2">
                            <div className="min-w-0 flex-1">
                                {issueUrl ? (
                                    <a
                                        ...
                                        className="text-sm text-white truncate block hover:text-[hsl(191,91%,60%)] hover:underline transition-colors"
                                    >
                                        {issueTitle}
                                    </a>
                                ) : (
                            ...
                            {issueUrl && (
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex-shrink-0 px-3 py-1.5 bg-[hsl(0,0%,100%,0.05)] hover:bg-[hsl(0,0%,100%,0.1)] text-[var(--foreground-muted)] hover:text-white text-xs font-medium rounded-lg border border-[var(--border)] flex items-center gap-1.5 transition-all"
                                >
